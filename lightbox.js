//La variable dentro de la expresíon//
 //no puede ser accesada desde afuera.//
 (function () {
...
var metLightbox = {
	...
	lightbox: function(imagen){
        ...
        propLightbox.modal.innerHTML += '<i id="cerrar_modal" class="fa fa-xmark" aria-hidden="true"></i>';
